...
roi1Names = {'85_Optic-Chiasm','85_Optic-Chiasm','Lt-LGN4','Rt-LGN4','Lt-LGN4',...
    'Rt-LGN4','Lt-LGN4','Rt-LGN4','Lt-LGN4','Rt-LGN4'};

roi2Names = {'Lt-LGN4','Rt-LGN4','lh_V1_smooth3mm_Half','rh_V1_smooth3mm_Half',...
    'lh_Ecc0to3','rh_Ecc0to3','lh_Ecc15to30','rh_Ecc15to30','lh_Ecc30to90','rh_Ecc30to90'};

%%
for ii = 1:length(fbName)
fgName =fbName{ii};
roi1Name = roi1Names{ii};
roi2Name = roi2Names{ii};
cleanFibers = 0;
computeVals = 1;
showFibers = 0;
segFgName  = [];
...
%%
afq = AO_AFQ_AddNewFiberGroup(afq,fgName,roi1Name,roi2Name,cleanFibers,computeVals,showFibers,segFgName,overwrite,fgNumber);

end
%%

%  afq = AFQ_AddNewFiberGroup(afq,fgName,roi1Name,roi2Name,cleanFibers,computeVals,showFibers,segFgName,overwrite,fgNumber)
